...
val mvnArtifactId = "json-utils-jvm" // see settings.gradle.kts
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name = mvnArtifactId
                description = "Utilities for using JSON"
                url = "https://github.com/wcarmon/json-utils-jvm"

                licenses {
                    license {
                        name = "MIT License"
                        url =
                            "https://raw.githubusercontent.com/wcarmon/json-utils-jvm/main/LICENSE"
                    }
                }
                ...
                scm {
                    connection =
                        "scm:git:git@github.com:wcarmon/json-utils-jvm.git"
                    developerConnection =
                        "scm:git:ssh://github.com:wcarmon/json-utils-jvm.git"
                    url = "https://github.com/wcarmon/json-utils-jvm/tree/main"
                }
            }
        }
    }
